    ...
    <div className="aboutUdaanBody" ref={ref}>
      ...
      <motion.div animate={animation} className="aboutUdaanSubBody">
        ...
        <p className="aboutUdaanPara">
          <span ref={audioRef}>EmpowerAbility</span>, one-stop platform that not only
          helps you find your unexplored wings but also lends hand in setting
          your flight in the best direction. EmpowerAbility connects the technology to
          ...
          required, rest we will take care of. Bringing a smile on the face
          and pride in the eyes of every specially-abled individual is the
          mission and vision of EmpowerAbility.
        </p>
      </motion.div>
    </div>
  );
